...
curl -X POST -d "document[html]=<html><head><title>my new blog</title></head><body><a>hellow world</a></body><html>" http://localhost:3000/documents.json

curl -X POST -d "document[url]=http://www.diegocarrion.com" http://localhost:3000/documents.json
